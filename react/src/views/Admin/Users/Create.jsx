                            ...
                            <form onSubmit={storeUser}>
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="input-group">
                                        ...
                                        <input ref={emailRef} className={`form-control ${errors && errors.email ? 'is-invalid' : ''}`} type="email" id="email" placeholder="Email" autoComplete="username" />
                                    </div>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <input ref={passwordRef} className={`form-control ${errors && errors.password ? 'is-invalid' : ''}`} type="password" id="password" placeholder="Password" autoComplete="new-password" />
                                            </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            <label htmlFor="password_confirmation" className="form-label">Password Confirmation <sup className="text-danger">*</sup></label>
                                            <div className="input-group">
                                                <span className="input-group-text">
                                                    <i className="bi bi-lock"></i>
                                                </span>
                                                <input ref={passwordConfirmationRef} className={`form-control ${errors && errors.passwordConfirmation ? 'is-invalid' : ''}`} type="password" id="password_confirmation" placeholder="Confirm" autoComplete="new-password" />
                                            </div>
